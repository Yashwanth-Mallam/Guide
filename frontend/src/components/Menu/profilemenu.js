...
const ProfileMenu = () => {
  ...
  const handleSignOutClick = (event) => {
    event.preventDefault();
    // Perform any additional logout logic here (e.g., clearing user data, session storage, etc.)
    ...
    <Card extra="items-center h-[25rem] w-[16rem] mt-1 -ml-4 mr-5 p-[16px] ">
      <div className="menu flex flex-col items-center p-5 -mt-7">
        <ul className="mr-2  ">
          ...
          <li className="mb-2 flex w-full items-center rounded-[20px] bg-white p-4 hover:bg-lightPrimary ">
          <button
              className="flex w-50% items-center rounded-[20px] bg-white p-4 hover:bg-lightPrimary focus:outline-none"
